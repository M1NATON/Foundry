...
## Corpus Check
- 135 files · ~107,987 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1081 nodes · 1927 edges · 75 communities (60 shown, 15 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1fb2e1ed`
...
Cohesion: 0.12
Nodes (17): dependencies, ioredis, multer, @nestjs/common, @nestjs/config, @nestjs/core, @nestjs/platform-express, rxjs (+9 more)
...
Cohesion: 0.07
Nodes (43): LibraryPage(), EditorPage(), EditorWorkspace(), EditorWorkspaceProps, nextKey(), ResearchView(), ResearchViewProps, SourceRow (+35 more)
...
### Community 23 - "duration-drift.test.ts"
Cohesion: 0.21
...
### Community 40 - ".create"
Cohesion: 0.33
Nodes (3): AssetsQueue, Injectable, promptFor()
...
### Community 52 - "editor-store.tsx"
Cohesion: 0.32
Nodes (5): EditorContext, EditorProvider(), EditorState, readStoredTheme(), Theme

### Community 53 - "upload.ts"
Cohesion: 0.40
Nodes (4): ALLOWED, AUDIO_EXT, IMAGE_EXT, VIDEO_EXT

### Community 54 - "primitives.tsx"
Cohesion: 0.15
Nodes (14): EmptyLibraryProps, NewProjectRowProps, Button, ButtonProps, Size, SIZES, Variant, VARIANTS (+6 more)

### Community 55 - "scenes.ts"
Cohesion: 0.21
Nodes (21): SceneInspector(), SceneListItem(), SceneListItemProps, StoryboardListView(), StoryboardListViewProps, AssetPreview(), AssetPreviewProps, invalidateProject() (+13 more)
...
Cohesion: 0.10
Nodes (18): readyTrack(), Stage(), StageProps, withUrl(), AssetMedia(), AssetMediaProps, MediaPlayer(), MediaPlayerProps (+10 more)
...
Cohesion: 0.17
Nodes (20): BarProps, LaneProps, MusicBar(), MusicLane(), SceneMusicOverride(), TakeChip(), plan(), PlannedScene (+12 more)

### Community 76 - "cn"
Cohesion: 0.12
Nodes (25): EditorChrome(), EditorChromeProps, LeftRail(), PipelineStepper(), PipelineStepperProps, ReadinessBadge(), BATCH, FillTheGaps() (+17 more)

## Knowledge Gaps
- **413 isolated node(s):** `$schema`, `collection`, `sourceRoot`, `deleteOutDir`, `webpack` (+408 more)
...
- **Why does `SCENE_ASSET_SLOTS` connect `helpers.test.ts` to `cn`, `scene.ts`?**
  _High betweenness centrality (0.196) - this node is a cross-community bridge._
- **Why does `ReadinessBadge()` connect `cn` to `timeline.tsx`, `scenes.ts`, `helpers.test.ts`?**
  _High betweenness centrality (0.194) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `timeline.tsx`, `stage.tsx`, `inspector-panel.tsx`, `music-track.tsx`, `import-storyboard-dialog.tsx`, `primitives.tsx`, `scenes.ts`?**
