...
## Corpus Check
- 132 files · ~104,767 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1063 nodes · 1879 edges · 81 communities (67 shown, 14 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `73078cd1`
...
6. `PrismaService` - 20 edges
7. `ScenesService` - 20 edges
...
- `TakeChip()` --calls--> `cn()`  [EXTRACTED]
  apps/web/src/components/editor/music-track.tsx → apps/web/src/lib/utils.ts
...
### Community 14 - "UserId"
Cohesion: 0.22
Nodes (11): ProjectMusicController, Body, Delete, Get, Param, Patch, Post, assertAllowedFile() (+3 more)

### Community 15 - "cn"
Cohesion: 0.21
Nodes (13): EditorChrome(), EditorChromeProps, LeftRail(), PipelineStepper(), PipelineStepperProps, ReadinessBadge(), BATCH, FillTheGaps() (+5 more)
...
Cohesion: 0.21
Nodes (15): EditorPage(), EditorWorkspace(), EditorWorkspaceProps, ScriptView(), ScriptViewProps, ExportPanel(), ImportStoryboardDialog(), ImportStoryboardDialogProps (+7 more)

### Community 21 - "research-view.tsx"
Cohesion: 0.29
...
Cohesion: 0.18
Nodes (22): SceneInspector(), SceneListItem(), SceneListItemProps, StoryboardListView(), StoryboardListViewProps, AssetPreview(), AssetPreviewProps, DriftBadge() (+14 more)
...
Cohesion: 0.25
Nodes (7): researchKeys, sceneKeys, scriptKeys, research, scene(), script, seed()

### Community 36 - "timeline.tsx"
Cohesion: 0.16
Nodes (14): ProducingView(), ProducingViewProps, clampZoom(), SceneCard, SceneCardProps, STATUS_TONE, tickStep(), Timeline() (+6 more)
...
Cohesion: 0.28
Nodes (6): EditorContext, EditorProvider(), EditorState, EditorStep, readStoredTheme(), Theme

### Community 39 - "storyboard.ts"
Cohesion: 0.17
Nodes (10): parseStoryboard(), extractJson(), ImportStoryboardDto, ImportStoryboardSchema, optionalText, StoryboardImport, StoryboardImportSchema, StoryboardObjectSchema (+2 more)
...
Cohesion: 0.14
Nodes (17): EmptyLibrary(), EmptyLibraryProps, Cover(), hashTone(), ProjectCard(), ProjectCardProps, Dialog(), DialogProps (+9 more)
...
Cohesion: 0.17
Nodes (13): hasDefaultTitle(), SCENE_ASSET_SLOTS, countSpokenWords(), countWords(), estimateSeconds(), estimateSpeechSeconds(), formatDuration(), formatSceneDuration() (+5 more)
...
Cohesion: 0.13
Nodes (15): readyTrack(), Stage(), StageProps, withUrl(), AssetMedia(), AssetMediaProps, MediaPlayer(), MediaPlayerProps (+7 more)

### Community 70 - ".assertOwned"
Cohesion: 0.26
Nodes (4): AssetsService, owningProjectId(), promptFor(), Injectable

### Community 71 - "preview-player.tsx"
Cohesion: 0.36
Nodes (7): plan(), PlannedScene, PreviewPlayer(), PreviewPlayerProps, readyUrl(), startAudio(), stopAudio()
...
Cohesion: 0.26
Nodes (14): BarProps, LaneProps, MusicBar(), MusicLane(), SceneMusicOverride(), TakeChip(), ProjectMusicNote(), invalidateMusic() (+6 more)

### Community 74 - "assets.controller.ts"
Cohesion: 0.36
Nodes (5): AssetsController, ProjectAssetsController, SceneAssetsController, Controller, UseGuards

### Community 75 - "projects.ts"
Cohesion: 0.29
Nodes (5): LibraryPage(), ProjectDetail, projectKeys, useCreateProject(), useProjects()

### Community 76 - "button.tsx"
Cohesion: 0.22
Nodes (8): NewProjectRow(), NewProjectRowProps, Button, ButtonProps, Size, SIZES, Variant, VARIANTS

### Community 77 - "export-panel.tsx"
Cohesion: 0.25
Nodes (5): ExportPanelProps, ExportResult, GROUPS, api, ApiError

### Community 78 - "src/research.ts"
Cohesion: 0.33
Nodes (5): Research, ResearchSchema, Source, UpsertResearchDto, UpsertResearchSchema

### Community 79 - "upload.ts"
Cohesion: 0.40
Nodes (4): ALLOWED, AUDIO_EXT, IMAGE_EXT, VIDEO_EXT
...
## Knowledge Gaps
- **410 isolated node(s):** `$schema`, `collection`, `sourceRoot`, `deleteOutDir`, `webpack` (+405 more)
...
- **Why does `ReadinessBadge()` connect `cn` to `helpers.test.ts`, `timeline.tsx`, `scenes.ts`?**
  _High betweenness centrality (0.187) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `timeline.tsx`, `stage.tsx`, `music-track.tsx`, `button.tsx`, `export-panel.tsx`, `editor-workspace.tsx`, `inspector-panel.tsx`, `primitives.tsx`, `scenes.ts`?**
