# Graph Report - Foundry  (2026-08-01)

## Corpus Check
- 135 files · ~184,372 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1045 nodes · 1891 edges · 68 communities (53 shown, 15 thin omitted)
...
Cohesion: 0.12
Nodes (17): @foundry/shared-types, dependencies, @foundry/shared-types, multer, @nestjs/common, @nestjs/config, @nestjs/core, @nestjs/platform-express (+9 more)
...
### Community 13 - "use-scene-field.ts"
Cohesion: 0.29
Nodes (7): keyOf(), lastUndoPushAt, PendingWrite, pendingWrites, SceneTextField, undoStacks, useSceneField()

### Community 14 - ".assertOwned"
Cohesion: 0.20
...
Cohesion: 0.05
Nodes (55): EditorPage(), EditorChrome(), EditorChromeProps, EditorWorkspace(), EditorWorkspaceProps, PipelineStepper(), PipelineStepperProps, ProducingView() (+47 more)

### Community 21 - "ResearchController"
Cohesion: 0.17
Nodes (9): ResearchController, Body, Controller, Get, Param, Put, UseGuards, parseSources() (+1 more)
...
### Community 35 - "src/research.ts"
Cohesion: 0.33
Nodes (5): Research, ResearchSchema, Source, UpsertResearchDto, UpsertResearchSchema

### Community 36 - "timeline.tsx"
Cohesion: 0.16
Nodes (14): clampZoom(), SceneCard, SceneCardProps, STATUS_TONE, tickStep(), Timeline(), TimelineProps, useUploadAsset() (+6 more)
...
Cohesion: 0.38
Nodes (6): sceneSecondsFromVoice(), logger, parseProbeDuration(), probeDurationSec(), run, WITH_ASSETS
...
Cohesion: 0.24
Nodes (6): PrismaService, Injectable, ProjectsService, Injectable, ResearchService, Injectable
...
Cohesion: 0.13
Nodes (20): LibraryPage(), EmptyLibrary(), EmptyLibraryProps, NewProjectRow(), NewProjectRowProps, Cover(), hashTone(), ProjectCard() (+12 more)

### Community 55 - "scenes.ts"
Cohesion: 0.17
Nodes (21): BATCH, FillTheGaps(), ReadinessPanelProps, SceneListItem(), SceneListItemProps, StoryboardListView(), StoryboardListViewProps, AssetPreview() (+13 more)
...
### Community 69 - "cn"
Cohesion: 0.15
Nodes (14): SceneTextarea(), LeftRail(), ReadinessBadge(), readyTrack(), Stage(), StageProps, withUrl(), AssetMedia() (+6 more)
...
- **Why does `cn()` connect `cn` to `timeline.tsx`, `inspector-panel.tsx`, `music-track.tsx`, `useEditor`, `primitives.tsx`, `scenes.ts`, `button.tsx`?**
