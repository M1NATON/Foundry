...
8. Проект экспортируется в Markdown, text, JSON, CSV, SRT, prompts, а также в FCPXML и EDL для монтажки.
...
| `GET`, `PATCH`, `DELETE` | `/projects/:id` | Получить, изменить (включая `brief`) или удалить проект |
...
| `POST` | `/projects/:id/export` | Экспортировать в `md`, `txt`, `json`, `csv`, `srt`, `prompts`, `fcpxml` или `edl` |
